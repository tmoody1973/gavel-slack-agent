...
- [ ] **RTS opposition seed is live + verified** in #clarke-square — top-level neighbor messages about #260229 (incl. *"We opposed a license like this… zero neighborhood input"*, *"testificar en contra"*, *"open code violation… neighborhood eyes before the vote"*). **Critical: the wow question must be opposition/sentiment-framed** (*"did we push back on this?"*) — fact-framed queries rank the official filing higher and can make Gavel say "no real discussion." Verified 2026-06-21: opposition surfaces for opposition-framed queries.
...
| **3 RTS wow** | 0:28–0:48 | In-thread, ask an **opposition-framed** question — *"¿ya nos opusimos a esto? / didn't we already push back on this?"* → Gavel surfaces the channel's own words: *"We should show up… zero neighborhood input"* — beside the matter record | "And it remembers what **this** neighborhood already said — their own words, next to the official record. Gavel never stores those messages; it queries them live." | **real** RTS query over the seeded thread *(thread disclosed as staged)* — **the wow, by 0:48** |
