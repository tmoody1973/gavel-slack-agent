...
> **v3 REVERIFIED 2026-07-12 (recording day):** the vote did NOT happen June 29 — all three files are
> still `In Committee` and are on the **JULY 20 City Plan Commission** agenda (EventId **13557**, status
> **Final**), confirmed live against Legistar. "Before the vote" is literal on camera: the vote is **8 days
> out, after the submission deadline** — judges can verify it themselves. All dates below updated to July 20.
...
> the vote is **real and imminent (July 20)** so "before the vote" is literal. The fully-verified Punta
> Cana script is preserved as the fallback at `docs/DEMO-SCRIPT-fallback-puntacana.md` — do **not**
> delete it until v2 is recorded.

## The through-line: one real story, a vote 8 days out
...
> the **July 20 City Plan Commission** agenda, the city is **writing the citywide data-center rules
...
the parcel beat answers the **literal question in the WTMJ headline**.
...
- Legistar July 20 **City Plan Commission** (EventId 13557), agenda status **Final** → Gavel's poller catches it for real.
...
- [ ] **Connect-the-dots:** confirm Gavel surfaces #260142 (citywide rule) and #260029/#260030 (this site) on the same July 20 agenda.
...
- [ ] **[If shipped] Statement tool:** the submit-a-comment flow drafts a bilingual public comment for #260030 and sends to a **test inbox** (never the real clerk) — disclose. + "📅 Add to calendar" deep link for the July 20 hearing.
...
|---|---|
| Legistar items #260142 / #260029 / #260030 on the Final July 20 agenda; parcel/MPROP (AFS MILWAUKEE LLC, RB2, open violation); zoning RAG; bilingual Claude generation; agenda-diff logic; (if built) the statement-tool draft + AgentMail send | The alert "fires" on a manual trigger during recording |
...
| — | **No meeting video** (July 20 is in the future) → document receipts (staff-report PDF) stand in for the video-clip beat |

---

## Notes / open choices

- **Timing risk (flag honestly):** this item was pulled once and could slip again. If July 20 moves, the "before the vote" line wobbles — but a second postponement **is** the agenda-change story, so it partly self-heals. Keep the Punta Cana fallback recordable until v2 is in the can.
