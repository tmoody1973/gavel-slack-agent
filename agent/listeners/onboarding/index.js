 ...
 * member-welcome on member_joined_channel + its two threaded-reply actions. Shares
 * the App Home dependency boundary (Convex reads/writes + channel names) so every
 * handler uses one injected deps object.
