...
export const COPY = {
  en: {
    ...
    neighborhoodLabel: '📍 Your neighborhood (optional)',
    neighborhoodPlaceholder: 'Search your neighborhood…',
  ...
  es: {
    ...
    neighborhoodLabel: '📍 Tu vecindario (opcional)',
    neighborhoodPlaceholder: 'Busca tu vecindario…',
